...
let activeStores_KPI = {
    ...
    get_view: (view_args_str) => {
        ...
        <div style="display: flex; flex-direction: column; align-items: center;  ">
            <div
                style="display: flex; align-items: center; background-image: url(/source/images/background_chart.png); width: 400px; height: 180px; background-size: cover;">
